...
abstract public class GameObject {
    protected int currentFrame;             // 当前动画帧  // 从0开始
    protected int speed;                    // 对象的速度
    protected int horizontalDirection;      // 当前对象水平移动方向
    protected int weight;                   // 当前对象大小(重量)
    ...
    protected float scalex;                    // 图片的缩放比例
    ...
    public void addWeight(int sumScore) {
        this.weight = (sumScore / 10 > 100 ? sumScore / 10 : 100);
    }
